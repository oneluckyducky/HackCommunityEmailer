...
public class Random {
	...
	/**
	 * @return A generated pseudo-random double between 0.0 (inclusive) and 1.0
	 *         (exclusive).
	 */
	...
	/**
	 * Generates a pseudo-random number between the two given values with
	 * standard deviation.
	 * 
	 * @param min
	 *            The minimum value (inclusive).
	 ...
	 * @return The generated pseudo-random integer.
	 */
	public static int nextGaussian(final int min, final int max,
			final int mean, final int sd) {
		if (min == max) {
			return min;
		}
		int rand;
